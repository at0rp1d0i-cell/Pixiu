...
- Only use fields and operators that the runtime has explicitly listed as available for the current run.
- If an optional field is unavailable, fall back to a price-volume proxy instead of guessing.
