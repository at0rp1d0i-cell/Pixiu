...
> 关联规格：`v2_interface_contracts.md`、`v2_orchestrator.md`、`v2_stage4_execution.md`、`v2_stage5_judgment.md`、`v2_factorpool.md`、`v2_test_pipeline.md`
...
- 规格实现验收以 `v2_test_pipeline.md` 中的 unit / integration / smoke 分层为准。
