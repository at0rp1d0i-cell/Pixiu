...
Purpose: Define how failed hypotheses are compressed into reusable structured constraints.
Status: active
...
> 依赖：`11_interface-contracts.md`, `24_stage-5-judgment.md`, `14_factor-pool.md`
> 实施计划：`docs/archive/plans/phase-2-hypothesis-engine.md` §2.1
...
```python
# src/agents/judgment/constraint_extractor.py — 新增
