...
Purpose: Define Pixiu's canonical objects and cross-plane contract boundaries.
Status: active
Audience: both
Canonical: yes
Owner: core docs
...
> 前置依赖：`../overview/03_architecture-overview.md`、`10_authority-model.md`
...
实现偏差与当前落地状态，请统一查看 `../overview/05_spec-execution-audit.md`。
