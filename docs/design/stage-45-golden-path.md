...
> 关联规格：`interface-contracts.md`、`orchestrator.md`、`stage-4-execution.md`、`stage-5-judgment.md`、`factor-pool.md`、`test-pipeline.md`
...
实现偏差和当前兼容层，请统一查看 `../overview/spec-execution-audit.md`。
...
- 规格实现验收以 `test-pipeline.md` 中的 unit / integration / smoke 分层为准。
