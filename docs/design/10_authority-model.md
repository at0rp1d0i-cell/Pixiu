...
Purpose: Define where intelligence is allowed to live in Pixiu and where deterministic systems must take over.
Status: active
Audience: both
Canonical: yes
Owner: core docs
...
> 创建：2026-03-10
> 优先级：**P0 — 运行时权限边界规格**
> 关联规格：`.../overview/03_architecture-overview.md`、`25_stage-45-golden-path.md`、`11_interface-contracts.md`
