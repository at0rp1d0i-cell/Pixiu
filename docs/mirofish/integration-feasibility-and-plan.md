...
- `docs/design/stage-2-hypothesis-expansion.md`
- `docs/design/stage-45-golden-path.md`
...
2. Stage 4→5 必须维持 deterministic golden path（`stage-45-golden-path.md`）。
3. Stage 2 是当前战略重点：扩大 hypothesis space，不扩大 execution power（`stage-2-hypothesis-expansion.md`）。
4. Layer 4（新闻/情绪）默认用于 Agent 上下文，不默认直接进入回测公式（`data-sources.md`）。
5. 必须遵守 point-in-time 防前视：**`available_time <= decision_time`**。
6. 测试分层必须遵守 smoke/unit/integration/live/e2e 体系，默认 merge gate 不依赖 live/e2e（`test-pipeline.md`）。
...
- `Pixiu/AGENTS.md`
- `Pixiu/docs/overview/spec-execution-audit.md`
- `Pixiu/docs/plans/current_implementation_plan.md`
- `Pixiu/docs/design/stage-2-hypothesis-expansion.md`
- `Pixiu/docs/design/stage-45-golden-path.md`
- `Pixiu/docs/design/data-sources.md`
- `Pixiu/docs/design/test-pipeline.md`
