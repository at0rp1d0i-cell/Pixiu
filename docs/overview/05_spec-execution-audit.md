...
| `16_test-pipeline.md` | active | 默认 pytest 入口已可用；当前 smoke/unit 基线为 524 passed，CLI smoke 与 approval 注入口径已补；marker 显式化与 runtime live env gating 已完成，但全局状态隔离和 contract test 仍在 Test Pipeline Refactor 中收口 |
