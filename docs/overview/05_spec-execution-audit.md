...
| `16_test-pipeline.md` | active | 默认 pytest 入口已可用；当前 smoke/unit 基线为 511 passed，CLI smoke 与 approval 注入口径已补 |
...
- canonical test entry 已存在，CLI / approval 的 smoke 路径已补齐；真实链路仍需 live / e2e 校验
